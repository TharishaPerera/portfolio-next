...
const FeaturedProject = ({type, title, summary, img, link, github}) => {
    return(
        <article className='w-full flex items-center justify-between rounded-3xl border border-solid border-dark/25 bg-light shadow-2xl p-6 relative'>
...
const Project = ({type, title, img, link, github}) => {
    return(
        <article className='w-ful flex flex-col items-center justify-center rounded-2xl border border-solid border-dark/25 bg-light shadow-2xl p-6 relative '>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <div className='w-full mt-2 flex items-center justify-between'>
                    <Link href={link} target='_blank' className='rounded-lg bg-dark text-light p-1 px-3 text-lg font-semibold'>View</Link>
